...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, camerafilter, framelist, keyfilter,
        ...
        krtpath = _DATA_ROOT + "experiments/dryice1/data/KRT"
        ...
        transfpath = _DATA_ROOT + "experiments/dryice1/data/pose.txt"
        ...
        if "bg" in self.keyfilter:
            ...
            for i, cam in enumerate(self.cameras):
                try:
                    imagepath = _DATA_ROOT + "experiments/dryice1/data/cam{}/bg.jpg".format(cam)
    ...
    def __getitem__(self, idx):
        ...
        if "fixedcamimage" in self.keyfilter:
            ...
            for i in range(ninput):
                imagepath = (
                        _DATA_ROOT + "experiments/dryice1/data/cam{}/image{:04}.jpg"
